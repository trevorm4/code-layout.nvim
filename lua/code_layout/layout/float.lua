...
local win = require("code_layout.window")
local is_ten = require("code_layout.util").is_ten
local M = {}
...
function M.right(left_winid, opt)
	...
	local right_spaces = vim.o.columns - wincol - (original.width or 0) - col
	...
	return win:new_float(win_conf, false, true)
		:winopt({
			["winhl"] = "NormalFloat:Normal,FloatBorder:Normal",
			["signcolumn"] = "no",
		})
